...
class ExtendedCacheHealthChecker:
    ...
    def __init__(self, 
        ...
        self.expected_base_columns = {
            ...
            # 基本指標
            'sma5', 'sma10', 'sma20', 'sma25', 'sma50', 'sma100', 'sma150', 'sma200',
            'ema12', 'ema20', 'ema26', 'ema50',
            'rsi3', 'rsi4', 'rsi14',
            'macd', 'macd_signal',
            'bb_upper', 'bb_middle', 'bb_lower',
            'atr10', 'atr14', 'atr20', 'atr40', 'atr50',
            'obv', 'stoch_k', 'stoch_d', 'williams_r',
            'cci', 'roc20', 'roc200', 'mfi', 'tsi', 'ultimate_oscillator',
            'hv50', 'dollarvolume20', 'dollarvolume50', 'avgvolume50',
            'return_pct', 'return_3d', 'return_6d', 'drop3d',
            'atr_ratio', 'atr_pct', 'adx7'
        }
    ...
    def _analyze_single_file(self, file_path: Path, profile: str) -> Optional[ExtendedHealthMetrics]:
        """単一ファイル分析"""
        try:
            # ファイル読み込み
    ...
    def analyze_profile(self, profile: str) -> List[ExtendedHealthMetrics]:
        ...
        with ThreadPoolExecutor(max_workers=self.max_workers) as executor:
            future_to_file = {
                executor.submit(self._analyze_single_file, file_path, profile): file_path
