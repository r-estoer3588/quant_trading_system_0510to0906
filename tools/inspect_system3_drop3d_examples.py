...
def main():
    ...
    p.add_argument("csvfile", nargs="?", default="results_csv_test/system3_filter_debug_all_20251021_145535.csv")
    ...
    print(f"Total rows where pre-filters passed (reason startswith 'pass'): {total_pass}")
